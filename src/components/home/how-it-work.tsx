  ...
  return (
    <>
      <Section className="md:pb-0 pb-0 mb-12 sm:mb-14">
        <h2 className="text-center text-xl pb-12">How it Works?</h2>
        <Container className="grid items-stretch md:grid-cols-2 md:gap-12 border border-sky-400/30 bg-sky-300/30 sm:rounded-lg">
      ...
      <Section className="md:pt-0 pt-0">
        <Container className="grid items-stretch md:grid-cols-2 md:gap-12 border border-green-400/30 bg-green-300/30 sm:rounded-lg">
